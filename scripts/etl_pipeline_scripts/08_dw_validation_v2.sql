/*==============================================================
  ...
  Purpose:
      ...
      Ensures completeness, integrity, and business sanity.
  ...
  Note:
      If any validation returns non-zero counts, the ETL run 
      should be reviewed before refreshing reporting datasets.
==============================================================*/
...
-- Quick sanity check for expected load volumes
-----------------------------------------------------
...
-- Ensure no missing surrogate keys or required fields
-----------------------------------------------------
PRINT 'STEP 2: FACT TABLE NULL CHECKS';

-- Sales fact table critical columns
...
-- Deliveries fact table critical columns
...
-- Verify that fact tables reference valid dimension keys
-----------------------------------------------------
...
-- Fact → Dimension consistency for deliveries
-----------------------------------------------------
...
-- Validate key aggregates and distributions
-----------------------------------------------------
...
-- Inspect distribution of facts for anomalies
-----------------------------------------------------
